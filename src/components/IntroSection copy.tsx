    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Container with cards and content panel as flex siblings */}
          <div className="relative w-full h-full flex items-center gap-8">
            ...
            {/* Expanded content panel - renders next to cards */}
            <div
              className="bg-white rounded-3xl shadow-xl overflow-y-auto transition-all duration-700 ease-out"
              style={{
                width: expandedCard ? '55%' : '0%',
                height: '100%',
                opacity: expandedCard ? 1 : 0,
                transform: expandedCard ? 'translateX(0)' : 'translateX(100px)',
              }}
            >
              <div className="p-8">
                {/* Back button */}
