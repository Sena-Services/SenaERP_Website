        ...
        <div className="flex items-center justify-center py-12 min-h-[480px]">
          <div className="flex flex-col items-center gap-4">
            <div className="relative w-16 h-16">
              ...
              <div className="absolute inset-0 border-4 border-sena-blue border-t-transparent rounded-full animate-spin"></div>
            </div>
              ...
              {!activeEnvironment ? (
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <h3 className="text-3xl font-bold leading-[1.15] text-sena-text-primary tracking-tight">
                      Launch-ready verticals built into Sena.
                    </h3>
                    <p className="text-base text-sena-text-secondary leading-relaxed">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-sena-blue">
                      What's included
                    </h4>
                    <div className="space-y-2 pl-3 border-l-2 border-sena-light-blue/30">
                      <div>
                        <p className="font-medium text-sm text-sena-text-primary">
                          Pre-built UI components
                        </p>
                        <p className="text-xs text-sena-text-secondary mt-0.5">
                  ...
                  <div className="flex-shrink-0 flex gap-3 flex-wrap">
                    {(() => {
                      ...
                      return (
                        ...
                        >
                          <div className="text-sena-blue flex-shrink-0">
                            {getIcon(metric.icon)}
                          </div>
                  ...
                  <div className="flex-1 overflow-y-auto space-y-3 pr-2 custom-scrollbar" style={{ minHeight: 0 }}>
                    ...
                    <ul className="space-y-1.5 pb-2">
                      {activeEnvironment.bullets.map((bullet, idx) => (
                        ...
                        >
                          <span className="mt-0.5 w-1 h-1 rounded-full bg-sena-blue flex-shrink-0" />
                          <span>{bullet}</span>
                        </motion.li>
                      ))}
                    </ul>
                  ...
                  <div className="flex-shrink-0 pt-3 border-t border-gray-200">
                    {activeEnvironment.status === 'In Development' ? (
                      ...
                      <Link
                        ...
                        className="group relative overflow-hidden rounded-lg bg-sena-blue px-4 py-2.5 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all hover:scale-[1.02] flex items-center justify-center gap-2"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
          ...
          <div className="flex gap-4" style={{ width: 'max-content' }}>
            {environments.map((environment, index) => {
              ...
              return (
                <motion.div
                  key={environment.id}
                  className="rounded-3xl border border-sena-blue bg-white shadow-xl flex-shrink-0 cursor-pointer"
                  style={{
                ...
                >
                  <div className={`flex w-full flex-col transition-all duration-300 ${expandedCards.has(environment.id) ? 'p-6' : 'p-6 pb-4'}`}>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <span className="text-xs uppercase tracking-[0.35em] text-sena-blue font-semibold">
                        {environment.label}
                      </span>
                    ...
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <h3 className="text-2xl font-semibold text-sena-text-primary leading-tight flex-1">
                        {environment.persona}
                      </h3>
                      <motion.div
                    ...
                    <div className={`grid grid-cols-2 gap-2 transition-all duration-300 ${expandedCards.has(environment.id) ? 'mb-4' : 'mb-0'}`}>
                      {(environment.metrics || [
                        ...
                        const getIcon = (iconName: string) => {
                          switch(iconName) {
                            case 'layout':
                              return <svg className="w-4 h-4 text-sena-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1v-3z" /></svg>;
                            case 'zap':
                              return <svg className="w-4 h-4 text-sena-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>;
                            case 'cpu':
                              return <svg className="w-4 h-4 text-sena-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" /></svg>;
                            case 'database':
                              return <svg className="w-4 h-4 text-sena-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg>;
                            default:
                              return null;
                          }
                        };
                    ...
                    <AnimatePresence>
                      {expandedCards.has(environment.id) && (
                        ...
                        >
                          <div className="space-y-3 text-sm text-sena-text-secondary">
                            ...
                            {environment.bullets.map((bullet) => (
                              <div key={bullet} className="flex items-start gap-3">
                                <span className="mt-1.5 inline-flex h-2 w-2 flex-none rounded-full bg-sena-blue" />
                                <span>{bullet}</span>
                              </div>
                            ))}
                            {environment.status === 'In Development' ? (
                              ...
                              <Link
                                href="/environment-selector"
                                className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-sena-blue text-white text-sm font-semibold rounded-full shadow-lg shadow-sena-blue/25 transition hover:bg-sena-blue-hover"
                              >
                                Launch this environment
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
          ...
          {environments.map((env, index) => (
            <button
              ...
              className={clsx(
                ...
                env.id === activeId ? "bg-sena-blue w-8" : "bg-gray-300 w-2"
              )}
