  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: "#F5F1E8" }}>
      ...
      >
        {/* Back link */}
        <Link
          href="/?section=how-it-works#join-us"
          className="inline-flex items-center gap-1.5 font-futura text-gray-500 hover:text-gray-800 transition-colors mb-10"
          style={{ fontSize: "14px" }}
        >
                ...
                <div className="flex-1 flex flex-col justify-center p-6">
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    >
                      ...
                      <span className="text-sm font-futura">{cofounder.email}</span>
                    </a>
